class JobsController < ApplicationController
  ...
  def new
    ...
    #  simplified because we will render a Turbo Frame in the new action to replace the slideover content instead of
    # broadcasting CableReady operations to update the DOM.
    @job = Job.new
  end
